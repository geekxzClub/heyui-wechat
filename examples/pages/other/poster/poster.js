// pages/other/poster/poster.js
const app = getApp()

Page({
  data: {
    cardInfo: {
      avater: "https://oss.geekxz.com/hey-ui-oss/heyui-shop/product/zhubao/1.png", //需要https图片路径
      qrCode: "https://oss.geekxz.com/hey-ui-oss/heyui-shop/product/zhubao/1.png", //需要https图片路径
      TagText: "小姐姐", //标签
      Name: '草莓前程蛋糕', //姓名
      Position: "鲜嫩多汁的草莓融合香甜奶油",
      Mobile: "你值得拥有！", 
      price: "￥88.88", 
    }
  },
