// pages/other/select/select.js
var cityData = require('../../../utils/metro.js'); //引入自己定义的深圳地铁区域及号线数据信息
Page({
  ...
  selectright: function(e) {
    ...
    this.setData({
      select3: e.currentTarget.dataset.index,      
      station: e.currentTarget.dataset.city,
    });
    wx.showToast({
      title: this.data.select1+'-'+this.data.select2+'-'+this.data.station,
      icon: 'none',
      duration: 1500
    })
  },
  ...
  submitFilter: function() {
    ...
    console.log('选择的三级选项是：' + this.data.station);
    // 隐藏地铁区域下拉框
    this.setData({
      qyopen: false,
      nzopen: false,
