...
Page({
   ...
   */
  data: {
    iconGood: '/static/images/dm/icon-good.png',
    avatarBoy: '/static/images/dm/icon_avatar_boy.png',
    avatarGirl: '/static/images/dm/icon_avatar_girl.png',
    iconBoy: '/static/images/dm/icon-boy.png',
    iconGirl: '/static/images/dm/icon-girl.png',
    baseData: [{
      "id": 786,
      "sex": 1,
